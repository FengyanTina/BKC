...
const getCurrentWeek = () => {
    ...
    return Array.from({ length: 7 }, (_, index) => {
      ...
      const dateOptions: Intl.DateTimeFormatOptions = { day: '2-digit', month: '2-digit' }; // Correct types for options
...
export default function RowAndColumnSpacing() {
  ...
  <React.Fragment key={index}>
    ...
    <Grid size={9} sx={{ alignContent: 'center' }}>
      <Item>
        <Typography>Details for {day.date}</Typography>
      </Item>
    </Grid>
    {/* This line would also render after the last item */}
    <Grid size={12}>
      <Box sx={{ borderBottom: '1px solid #ccc', width: '100%', my: 1 }} />
    </Grid>
  </React.Fragment>
))}
